print(">>> autocorrect.__init__.py cargado")
import json
import os
import re
import sys
...
def clean_text(text):
    ...
    text = re.sub(r"\s+", " ", text).strip()  # dobles espacios
    return text
    ...
    def get_candidates(self, word):
        ...
        # Hibrido
            ...
            candidates = (
                ...
                or (self.existing(w.double_typos()) if len(word) >= 7 else set())
                or [word]
            )
        else:
            candidates = (
